                ...
                var t = function (t) {
                    ...
                    this.toggleFocus          = function () {
                        ...
                        u
                            .nodeElement()
                            .select("circle")
                            .classed("focused", u.focused())
                    },
                    this.actualRadius         = function () {
                        if (!t.options().scaleNodesByIndividuals() || u.individuals().length <= 0)
                            return u.radius();
                        var n = 8,
                    ...
                    this.postDrawActions      = function () {
                        ...
                        t
                            .options()
                            .compactNotation() || n.addSubText(u.indicationString()),
        ...
        t.exports = function () {
            var t = function (t) {
                ...
                this.addMouseListeners  = function () {
                    return p.nodeElement()
                        ? void p
                            .nodeElement()
                            .selectAll("*")
                            .on("mouseover", n)
                            .on("mouseout", e)
                        : void console.warn(this)
                },
                i.addTo(this)
            };
            return t.prototype      = Object.create(r.prototype),
        ...
        (function (n) {
            ...
            t.exports = function (t) {
                function e() {
                    var t = i();
                    if (1 > t)
                        return void f.attr("y", 0);
                    var n = u(f);
                    f.attr("y", .6 * -n + "px")
                }
                function i() {
                    return f.property("childElementCount") - f
                        .selectAll(".instance-count")
                        .size()
                }
                function a(a, u, c, p) {
                    if (a) {
        ...
        (function (n) {
            ...
            i.truncate = function (t, n, i, a) {
                ...
                for (var o, s, u, c = t;;) {
                    if (s = e(c, i), n >= s)
                        break;
                    if (u = s / n, o = Math.floor(c.length / u), c.length === o)
                        break;
                    c = c.substring(0, o)
                }
                return t.length > c.length
                    ? t.substring(0, c.length - 3) + "..."
                    : t
            },
            t.exports  = function () {
                return i
                ...
                var t = 40,
                    e = function (e) {
                        ...
                        this.setHoverHighlighting = function (t) {
                            a(t),
                            n
                                .selectAll(".special." + i.cssClassOfNode())
                                .classed("hovered", t)
                        },
                        this.postDrawActions      = function () {
                            o(),
                            ...
                            i
                                .textBlock()
                                .addInstanceCount(i.individuals().length),
                            i
                                .textBlock()
                                .setTranslation(0, i.radius() - 15)
                        }
                    };
            ...
            var t = function (t) {
                ...
                this.draw = function (t) {
                    ...
                    e
                        ...
                        .attr("class", "nostroke")
                        .classed("symbol", !0)
                        .attr("d", "m 24.777,0.771 c0,16.387-13.607,23.435-19.191,23.832S-15.467,14.526-15.467,0.424" +
                                "S-1.216-24.4,5.437-24.4 C12.09-24.4,24.777-15.616,24.777,0.771z"),
                    e
                        .append("circle")
                        .attr("class", "nofill")
                        .classed("fineline", !0)
            ...
            var t = function (t) {
                ...
                this.toggleFocus          = function () {
                    ...
                    n
                        .nodeElement()
                        .select("rect")
                        .classed("focused", n.focused())
                },
                this.draw                 = function (t, r) {
                    var a,
                        o = n.collectCssClasses();
                    n.nodeElement(t),
                ...
                o = function (t) {
                    ...
                    function a(t) {
                        ...
                        n.forEach(function (n) {
                            n
                                .labelElement()
                                .select("rect")
                                .classed("indirectHighlighting", t)
                        })
                    }
                    function o() {
                        var t = [];
                    ...
                    this.draw                  = function (t) {
                        function n(n) {
                            ...
                            n.addRect(r);
                            var i = e(15)(r);
                            return n instanceof e(36)
                                ? (n.addDisjointLabel(t, i), r)
                                : (i.addText(n.labelForCurrentLanguage()), i.addSubText(n.indicationString()), n.addEquivalentsToLabel(i), r)
                        }
                        if (!C.labelVisible())
                            return void 0;
                    ...
                    this.addRect               = function (t) {
                        ...
                        e
                            .append("title")
                            .text(C.labelForCurrentLanguage()),
                    ...
                    this.addDisjointLabel      = function (n, e) {
                        ...
                        t
                            .options()
                            .compactNotation() || e.addSubText("disjoint"),
                    ...
                    this.drawCardinality       = function (t) {
                        if (void 0 === C.minCardinality() && void 0 === C.maxCardinality() && void 0 === C.cardinality())
                            return void 0;
                        C.cardinalityElement(t.classed("cardinality", !0));
                        var n = t
                            .append("text")
                            .classed("cardinality", !0)
                            .attr("text-anchor", "middle")
                            .attr("dy", "0.5ex");
                        if (void 0 !== C.minCardinality()) {
                            var e = C.minCardinality() + "..";
                            e += void 0 !== C.maxCardinality()
                                ? C.maxCardinality()
                                : "*",
                            n.text(e)
                        } else
                            void 0 !== C.maxCardinality()
                                ? n.text("*.." + C.maxCardinality())
                                : void 0 !== C.cardinality() && n.text(C.cardinality());
            ...
            t.exports = function (t) {
                ...
                function u() {
                    ...
                    F = n
                        ...
                        .zoom()
                        .duration(150)
                        .scaleExtent([U.minMagnification(), U.maxMagnification()])
                        .on("zoom", s)
                }
                function c(t) {
                    var n = t.link();
                    if (n.isLoop())
                        return U.loopDistance();
                    var e = l(n);
                    return e += n
                        .domain()
                        .actualRadius(),
                ...
                function l(t) {
                    return a.isDatatype(t.domain()) || a.isDatatype(t.range())
                        ? U.datatypeDistance()
                        : U.classDistance()
                }
                function p() {
                    x(),
                    w = n
                        .selectAll(U.graphContainerSelector())
                        .append("svg")
                        .classed("vowlGraph", !0)
                        .attr("width", U.width())
        ...
        t.exports = function (t, n, i) {
            ...
            c.draw          = function (t, n) {
                ...
                t
                    .append("path")
                    .classed("link-path", !0)
                    .classed(l.cssClassOfNode(), !0)
                    .classed(f.cssClassOfNode(), !0)
                    .classed(e.linkType(), !0)
            ...
            t.exports = function (t) {
                ...
                function v(t, n, e) {
                    ...
                    t.forEach(function (t) {
                        ...
                        if (t.domain() && t.range() || t.inverse()) {
                            ...
                            "undefined" != typeof t.domain() && "undefined" != typeof t.range()
                                ? (r = N(t.domain()), i = N(t.range()), a = n[r], o = n[i])
                                : s
                                    ? (r = N(s.range()), i = N(s.domain()), a = n[r], o = n[i])
                                    : console.warn("Domain and range not found for property: " + t.id()),
                            t.domain(a),
                            t.range(o),
                ...
                function y(t) {
                    ...
                    if (t)
                        for (n = 0, e = t.length; e > n; ++n) {
                            ...
                            i
                                ? t[n] = i
                                : console.warn("No sub-/superproperty was found for id: " + r)
                        }
                    }
                function m(t) {
                ...
                function b(t, n) {
                    ...
                    for (e = 0, r = t.length; r > e; e++)
                        ...
                        else if (n.type() === i.type() && n.defaultLabel() === i.defaultLabel())
                        return i;
                    return void 0
                }
                function x(t, n) {
                    ...
                    if (e && !t.equivalentBase())
                        for (var r = 0, i = e.length; i > r; ++r) {
                            var a = N(e[r]),
                                o = n[a];
                            o
                                ? (o.equivalents(o.equivalents()), o.equivalents().push(t), o.equivalentBase(t), e[r] = o, o.visible(!1))
                                : console.warn("No class/property was found for equivalent id: " + a)
                        }
                    }
                function C(t, n) {
                    t.forEach(function (t) {
                ...
                function k(t, n) {
                    n = n || {};
                    for (var e in n)
                        e in t || !n.hasOwnProperty(e) || (t[e] = n[e]);
                    return t
                }
                function O(t, n) {
                    var e = t.indexOf(":");
                ...
                function N(t) {
                    return t
                        ? "string" == typeof t
                            ...
                            : "id" in t
                                ? t.id()
                                : void console.warn("No Id was found for this object: " + t)
                        : void 0
                }
                var L,
                    A,
        ...
        (function (n) {
            t.exports = function () {
                ...
                return e.handle = function (e) {
                    n.event.defaultPrevented || (void 0 !== t && t.toggleFocus(), t !== e
                        ? (e.toggleFocus(), t = e)
                        : t = void 0)
                },
                e.reset         = function () {
    ...
    function (t, n, e) {
        ...
        t.exports = function () {
            ...
            return f.filter          = function (n, r) {
                ...
                s = r,
                t(),
                this.enabled() && (p instanceof Function
                    ? e(p())
        ...
        (function (n) {
            ...
            t.exports = function () {
                ...
                function u(t) {
                    ...
                    t.forEach(function (t) {
                        o.isDatatype(t)
                            ? e.add(t.defaultLabel())
                            : t instanceof r || (t instanceof i
                                ? s = !0
                                : t instanceof a
                                    ? u = !0
                                    : (v += 1, v += p(t.equivalents())))
                    }),
                    v += s
                        ? 1
                        : 0,
                ...
                function c(t) {
                    for (var n = 0, e = t.length; e > n; n++) {
                        var r = t[n];
                        o.isObjectProperty(r)
                            ? b += l(r)
                            : o.isDatatypeProperty(t) && (m += l(r))
                    }
                    x = b + m
                }
                function l(t) {
                ...
                function d(t) {
                    for (var n = 0, e = 0, r = t.length; r > e; e++)
                        n += t[e]
                            .individuals()
                            .length || 0;
                    w = n
